...
public class FSM {
	...
	public void init() {
		...
		name = "Start";
		transitions.add(new Transition("external", "", "Fail1"));
		onexit.add(new Event("Next"));
		onexit.add(new Event("Next"));
		...
		name = "Fail1";
		transitions.add(new Transition("external", "Next", "Fail2"));
		states.put(name, new State(name, transitions, onentry, onexit));
		name = ""; transitions = new ArrayList<Transition>();
		onentry = new ArrayList<Action>();
		onexit = new ArrayList<Action>();
		...
		name = "Fail2";
		transitions.add(new Transition("external", "Next", "Pass"));
		states.put(name, new State(name, transitions, onentry, onexit));
		name = ""; transitions = new ArrayList<Transition>();
		onentry = new ArrayList<Action>();
		onexit = new ArrayList<Action>();
