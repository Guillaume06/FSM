...
public class FSM {
	...
	public void init() {
		...
		name = "Start";
		transitions.add(new Transition("external", "Next", "Fail1"));
		onentry.add(new Event("Next"));
		onentry.add(new Event("Next1"));
		onexit.add(new Event("Next2"));
		onexit.add(new Event("Next3"));
		...
		name = "Fail1";
		transitions.add(new Transition("external", "Next1", "Fail2"));
		states.put(name, new State(name, transitions, onentry, onexit));
		name = ""; transitions = new ArrayList<Transition>();
		onentry = new ArrayList<Action>();
		onexit = new ArrayList<Action>();
		...
		name = "Fail3";
		transitions.add(new Transition("external", "Next3", "Pass"));
		states.put(name, new State(name, transitions, onentry, onexit));
		name = ""; transitions = new ArrayList<Transition>();
		onentry = new ArrayList<Action>();
		onexit = new ArrayList<Action>();
		...
		name = "Fail2";
		transitions.add(new Transition("external", "Next2", "Fail3"));
		states.put(name, new State(name, transitions, onentry, onexit));
		name = ""; transitions = new ArrayList<Transition>();
		onentry = new ArrayList<Action>();
		onexit = new ArrayList<Action>();
